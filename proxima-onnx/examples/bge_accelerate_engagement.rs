...
fn main() {
    ...
    #[cfg(all(target_os = "macos", target_arch = "aarch64"))]
    {
        ...
        println!("ACCELERATE_GEMM_ENABLED=true, accelerate_gemm_totals() = (hits={hits}, declined={declined})");
        println!(
        ...
        assert_eq!(hits, 0, "claim under test: accelerate never fires on BGE's width-tile-routed GEMMs");
    }
